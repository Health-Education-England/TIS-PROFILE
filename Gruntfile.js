...
module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		clean: {
			...
			server: '.tmp',
			scripts: '<%= yeoman.dist %>/scripts',
			styles: '<%= yeoman.dist %>/styles'
		},
		...
		less: {
			dist: {
				...
				files: {
					'<%= yeoman.app %>/app/styles/main.css': '<%= yeoman.app %>/app/styles/less/main.less'
				}
			},
			dev: {
				options: {
		...
		concat: {
			translations: {
				...
				files: {
					'<%= yeoman.dist %>/i18n/locale-en.json': [
						'<%= yeoman.app %>/app/**/*.i18n.en.json'
					]
				}
			}
		},
		...
		insert: {
			...
			translations: {
				...
				dest: '<%= yeoman.dist %>/scripts/hee.js',
				match: '//::translations:://'
			}
		},
		...
		copy: {
			...
			prod: {
				files: [{
					...
					expand: true,
					cwd: '<%= yeoman.app %>/app/fonts/icomoon/fonts',
					src: '*.{eot,ttf,woff}',
