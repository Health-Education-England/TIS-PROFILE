ALTER TABLE `Permission` ADD `principal` VARCHAR(255) DEFAULT 'Placeholder' NOT NULL;
ALTER TABLE `Permission` ADD `resource` VARCHAR(255) DEFAULT 'Placeholder' NOT NULL;
ALTER TABLE `Permission` ADD `actions` VARCHAR(255) DEFAULT 'Placeholder' NOT NULL;
ALTER TABLE `Permission` ADD `effect` VARCHAR(255) DEFAULT 'Placeholder' NOT NULL;
