...
public class AuditingAspect {
  ...
  private final static String PROFILE_PREFIX = "profile_";
   ...
   */
  @Pointcut("execution(* com.transformuk.hee.tis.profile.web.rest.*.create*(..))")
   ...
   */
  @Pointcut("execution(* com.transformuk.hee.tis.profile.web.rest.*.update*(..))")
   ...
   */
  @Pointcut("execution(* com.transformuk.hee.tis.profile.web.rest.*.delete*(..))")
  ...
  public void auditUpdateBeforeExecution(JoinPoint joinPoint) throws Throwable {
    // TODO: Review auditing implementation, increased accessibility via reflection flagged as a potential issue.
