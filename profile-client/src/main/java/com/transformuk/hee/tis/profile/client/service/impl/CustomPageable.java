...
public class CustomPageable<T> extends PageImpl<T> {
  ...
  public String getNextPageRequestParameters() {
    ...
    if(this.hasNext()){
      nextPage = "page=" + this.nextPageable().getPageNumber() + "&size=" + this.nextPageable().getPageSize();
    }
    return nextPage;
  }
  ...
  public String getPreviousPageRequestParameters() {
    ...
    if(this.hasNext()){
      previousPage = "page=" + this.previousPageable().getPageNumber() + "&size=" + this.nextPageable().getPageSize();
    }
    return previousPage;
  }
}
